...
const CHART_DISABLED_MSG =
  'Charting tools are disabled. Enable exposeCharting in MCP config to use chart_* tools.';

function disabled() {
  return errorResponse(CHART_DISABLED_MSG);
}
...
const ChartConfigSchema = {
  ...
  height: z
    ...
    .max(4000)
    .optional()
    .describe('Chart height in pixels (default 500)'),
  ...
  server.tool(
    ...
    'Generate an OHLCV candlestick chart as SVG with optional volume bars and moving averages',
    {
      ...
      movingAverages: z
        ...
        .max(5)
        .optional()
        .describe('Simple moving average overlays'),
            ...
            text: JSON.stringify(
              {
                ...
                data: {
                  ...
                  priceRange: [
                    Math.min(...args.data.map((d) => d.low)),
                    Math.max(...args.data.map((d) => d.high)),
                  ],
                },
              },
              null,
              ...
              .array(
                z.object({
                  x: z
                    ...
                    .describe('X value (numeric or category label)'),
            ...
            text: JSON.stringify(
              {
                ...
                data: {
                  ...
                  pointCount: args.series.reduce((a, s) => a + s.data.length, 0),
                },
              },
              null,
              2
  ...
  server.tool(
    ...
    'Generate a grouped or stacked bar chart as SVG for comparisons and allocations',
    {
      data: z
        ...
        .min(1)
        .describe('Bar data grouped by category'),
  ...
  server.tool(
    ...
    'Generate a pie or donut chart as SVG for portfolio allocation and distributions',
    {
      ...
      donutWidth: z
        ...
        .max(200)
        .optional()
        .describe('Donut ring width in pixels (default 40)'),
      ...ChartConfigSchema,
    },
  ...
  server.tool(
    ...
    'Generate a scatter plot as SVG for risk vs return and correlation analysis',
    {
      ...
      showTrendLine: z
        .boolean()
        .optional()
        .describe('Show linear regression trend line (default false)'),
      ...ChartConfigSchema,
    },
  ...
  server.tool(
    ...
    'Generate a waterfall chart as SVG for P&L breakdown and synergy bridges',
    {
      items: z
        ...
        .min(1)
        .describe('Waterfall items in order'),
      ...ChartConfigSchema,
    },
  ...
  server.tool(
    ...
    wrapToolHandler('chart_heatmap', middleware, async (args) => {
      ...
      const svg = renderHeatmap(
        { labels: args.labels, values: args.values },
        {
  ...
  server.tool(
    ...
    'Generate a compact inline sparkline as SVG for quick trend indicators',
    {
      ...
      height: z
        ...
        .max(200)
        .optional()
        .describe('Sparkline height (default 30)'),
            ...
            text: JSON.stringify(
              {
                svg,
                data: {
                  pointCount: args.values.length,
                  min: Math.min(...args.values),
                  max: Math.max(...args.values),
                },
              },
              null,
              2
