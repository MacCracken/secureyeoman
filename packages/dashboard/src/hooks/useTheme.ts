...
export const THEMES: ThemeMeta[] = [
  ...
  { id: 'everforest',          name: 'Everforest',           isDark: true,  preview: ['#2d3b35', '#d4c6a1', '#a7c080'] },
  ...
  { id: 'catppuccin-macchiato',name: 'Catppuccin Macchiato', isDark: true,  preview: ['#24273a', '#cad3f5', '#c6a0f6'] },
  ...
  { id: 'dracula',             name: 'Dracula',              isDark: true,  enterprise: true, preview: ['#282a36', '#f8f8f2', '#bd93f9'] },
  { id: 'solarized-dark',      name: 'Solarized Dark',       isDark: true,  enterprise: true, preview: ['#002b36', '#839496', '#268bd2'] },
  ...
  { id: 'solarized-light',     name: 'Solarized Light',      isDark: false, enterprise: true, preview: ['#fdf6e3', '#657b83', '#268bd2'] },
  { id: 'github-light',        name: 'GitHub Light',         isDark: false, enterprise: true, preview: ['#ffffff', '#24292f', '#0969da'] },
