 ...
 *
 * Standalone departmental risk management component used in both
 * the Security > Risk tab and the Organization page.
 */

import { useState, lazy, Suspense } from 'react';
import { useQuery, useQueryClient } from '@tanstack/react-query';
import { Plus, Edit2, Loader2, RefreshCw, Building } from 'lucide-react';
import {
  fetchDepartments,
