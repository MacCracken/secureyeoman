...
export const CARD_REGISTRY: readonly CardDef[] = [
  {
    ...
    description: 'At-a-glance KPI stats',
    defaultVisible: true,
    pinned: true,
    minColSpan: 12,
    defaultColSpan: 12,
  },
  {
    ...
    description: 'CPU, memory, token usage over time',
    defaultVisible: true,
    minColSpan: 6,
    defaultColSpan: 12,
  },
  ...
  },
  {
    id: 'agent-health',
    label: 'Agent Health',
    description: 'Personality heartbeat overview',
    defaultVisible: true,
    minColSpan: 4,
    defaultColSpan: 4,
  },
  {
    id: 'system-health',
    label: 'System Health',
    description: 'MCP servers and heartbeat tasks',
    defaultVisible: true,
    minColSpan: 3,
    defaultColSpan: 3,
  },
  ...
  },
  {
    id: 'audit-stream',
    label: 'Audit Stream',
    description: 'Live audit log entries',
    defaultVisible: true,
    minColSpan: 3,
    defaultColSpan: 3,
  },
  ...
  },
  {
    ...
    description: 'Token spend by model and provider',
    defaultVisible: true,
    minColSpan: 6,
    defaultColSpan: 6,
  },
  {
    id: 'agent-world',
    label: 'Agent World',
    description: 'Live ASCII personality activity',
