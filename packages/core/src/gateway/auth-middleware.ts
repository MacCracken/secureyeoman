...
const ROUTE_PERMISSIONS: Record<string, Record<string, RoutePermission>> = {
  ...
  '/api/v1/spirit/passions': {
    GET: { resource: 'spirit', action: 'read' },
    POST: { resource: 'spirit', action: 'write' },
  },
  '/api/v1/spirit/passions/:id': {
    GET: { resource: 'spirit', action: 'read' },
    PUT: { resource: 'spirit', action: 'write' },
    DELETE: { resource: 'spirit', action: 'write' },
  },
  ...
  '/api/v1/conversations': {
    GET: { resource: 'chat', action: 'read' },
    POST: { resource: 'chat', action: 'write' },
  },
  '/api/v1/conversations/:id': {
    GET: { resource: 'chat', action: 'read' },
    PUT: { resource: 'chat', action: 'write' },
    DELETE: { resource: 'chat', action: 'write' },
  },
  ...
  '/api/v1/proactive/triggers': {
    ...
    POST: { resource: 'proactive', action: 'write' },
  },
  '/api/v1/proactive/triggers/builtin': { GET: { resource: 'proactive', action: 'read' } },
  '/api/v1/proactive/triggers/:id': {
    GET: { resource: 'proactive', action: 'read' },
    PATCH: { resource: 'proactive', action: 'write' },
    DELETE: { resource: 'proactive', action: 'write' },
  },
  ...
  // Extensions
  '/api/v1/extensions': {
    GET: { resource: 'extensions', action: 'read' },
    POST: { resource: 'extensions', action: 'write' },
  },
  ...
  '/api/v1/extensions/webhooks/:id': {
    PUT: { resource: 'extensions', action: 'write' },
    DELETE: { resource: 'extensions', action: 'write' },
  },
  ...
  '/api/v1/auth/roles/:id': {
    PUT: { resource: 'auth', action: 'write' },
    DELETE: { resource: 'auth', action: 'write' },
  },
  ...
  '/api/v1/gmail/profile': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/gmail/messages': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/gmail/messages/:id': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/gmail/threads/:id': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/gmail/labels': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/gmail/drafts': { POST: { resource: 'integrations', action: 'write' } },
  '/api/v1/gmail/send': { POST: { resource: 'integrations', action: 'write' } },
  '/api/v1/twitter/profile': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/twitter/search': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/twitter/tweets/:id': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/twitter/users/:username': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/twitter/mentions': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/twitter/timeline': { GET: { resource: 'integrations', action: 'read' } },
  '/api/v1/twitter/tweet': { POST: { resource: 'integrations', action: 'write' } },
  '/api/v1/twitter/tweets/:id/like': { POST: { resource: 'integrations', action: 'write' } },
