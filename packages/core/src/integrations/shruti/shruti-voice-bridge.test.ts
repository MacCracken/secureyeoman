...
function createMockClient(): ShrutiClient {
  return {
    ...
    listTracks: vi.fn().mockResolvedValue([
      { index: 0, name: 'Drums', track_type: 'audio', gain_db: 0, pan: 0, muted: false, soloed: false, region_count: 1 },
      { index: 1, name: 'Bass', track_type: 'audio', gain_db: -3, pan: 0, muted: false, soloed: false, region_count: 1 },
      { index: 2, name: 'Vocals', track_type: 'audio', gain_db: -1, pan: 0, muted: false, soloed: false, region_count: 2 },
    ]),
