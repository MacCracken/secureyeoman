...
const SERVICE_REGISTRY: readonly ServiceDefinition[] = [
  ...
  },
  {
    ...
    description:
      'AI-native image editor with GPU-accelerated rendering, generative AI, and MCP tool integration. Stdio MCP transport — register rasa-mcp binary path via MCP server config.',
    urlEnv: 'RASA_MCP_PATH',
    defaultUrl: 'stdio://rasa-mcp',
    healthPath: '',
    requiredSecrets: [],
