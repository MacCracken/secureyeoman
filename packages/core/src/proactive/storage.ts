...
function triggerFromRow(
  ...
  return {
    ...
    condition: safeJsonParse(row.condition, {}) as ProactiveTrigger['condition'],
    action: safeJsonParse(row.action, {}) as ProactiveTrigger['action'],
...
function suggestionFromRow(row: SuggestionRow): Suggestion {
  ...
  return {
    ...
    action: safeJsonParse(row.action, {}) as Suggestion['action'],
