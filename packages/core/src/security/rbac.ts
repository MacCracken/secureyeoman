...
const DEFAULT_ROLES: RoleDefinition[] = [
  ...
  },
  {
    id: 'role_operator',
    name: 'Operator',
    description: 'Can manage tasks and integrations',
    permissions: [
      { resource: 'tasks',        actions: ['read', 'write', 'execute', 'cancel'] },
      { resource: 'integrations', actions: ['read', 'write', 'delete', 'test'] },
      { resource: 'metrics',      actions: ['read'] },
      { resource: 'logs',         actions: ['read'] },
      { resource: 'reports',      actions: ['read', 'write'] },
      { resource: 'soul',         actions: ['read', 'write'] },
      { resource: 'spirit',       actions: ['read', 'write'] },
      { resource: 'brain',        actions: ['read', 'write'] },
      { resource: 'comms',        actions: ['read', 'write'] },
      { resource: 'model',        actions: ['read', 'write'] },
      { resource: 'mcp',          actions: ['read', 'write', 'execute'] },
      { resource: 'dashboards',   actions: ['read', 'write'] },
      { resource: 'workspaces',   actions: ['read', 'write'] },
      { resource: 'experiments',  actions: ['read', 'write'] },
      { resource: 'marketplace',  actions: ['read', 'write'] },
      { resource: 'multimodal',   actions: ['read', 'write'] },
      { resource: 'chat',         actions: ['read', 'write', 'execute'] },
      { resource: 'execution',    actions: ['read', 'write', 'execute'] },
      { resource: 'agents',       actions: ['read', 'write'] },
      { resource: 'proactive',    actions: ['read', 'write'] },
  ...
  },
  {
    ...
    permissions: [
      ...
      { resource: 'proactive', actions: ['read'] },
      { resource: 'browser', actions: ['read'] },
  ...
  },
  {
    ...
    permissions: [
      ...
      { resource: 'spirit',      actions: ['read'] },
      { resource: 'brain',       actions: ['read'] },
