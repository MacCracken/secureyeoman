...
export {
  ExternalizationGate,
  type ExternalizationGateDeps,
  type GatedResult,
} from './externalization-gate.js';
export { QuarantineStorage, type QuarantineMetadata } from './quarantine-storage.js';
export {
  ScanHistoryStore,
  type ScanHistoryRecordInput,
  type ScanHistoryListOptions,
  type ScanStats,
} from './scan-history-store.js';
...
export {
  OffenderTracker,
  type OffenderTrackerConfig,
  type OffenderStatus,
} from './offender-tracker.js';
