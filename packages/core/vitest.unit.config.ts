...
const DB_TEST_EXCLUDE = [
  ...
  'src/brain/brain-db-storage.test.ts',
  'src/brain/brain-db-manager.test.ts',
  ...
  'src/soul/soul-db-storage.test.ts',
  'src/soul/soul-db-manager.test.ts',
  'src/spirit/spirit.test.ts',
  'src/spirit/spirit-db-storage.test.ts',
  'src/spirit/spirit-db-manager.test.ts',
  ...
  'src/marketplace/marketplace-db-storage.test.ts',
  'src/marketplace/marketplace-db-manager.test.ts',
  'src/marketplace/marketplace-db-community.test.ts',
