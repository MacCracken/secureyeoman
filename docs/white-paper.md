...
SecureYeoman ships today (v2026.2.28) with 9,916 tests at ≥ 87% coverage, 166 Architecture Decision Records, and a production Kubernetes Helm chart. It runs fully air-gapped on your infrastructure: no cloud dependency, no behavioral extraction, no AI that answers to someone else.
...
*SecureYeoman v2026.2.28 — 9,916 tests · ≥ 87% coverage · 166 ADRs · MIT License*
